...
English, `"zh-CN"` for Simplified Chinese, or `"ko"` for Korean. The renderer
...
For a requested language outside `en`, `zh-CN`, and `ko`, do not write an
unsupported locale. Keep every reader-facing authored string in the requested language,
